...
def empresa(request, id):
    ...
    if request.method == "GET":
        ...
        return render(request, 'empresa.html', {'empresa':empresa, 'documentos':documentos, 'proposta_investimentos_enviada':proposta_investimentos_enviada, 
                                                'percentual_vendido': int(percentual_vendido), 'total_capitado':total_captado, 'valuation_atual': valuation_atual})
...
def add_doc(request, id):
    ...
    if empresa.user != request.user:
        messages.add_message(request, constants.ERROR, "Essa empresa não é sua")
        return redirect(f'/empresarios/lista_empresa')
    ...
    messages.add_message(request, constants.SUCCESS, 'Arquivos cadastrado com sucesso')
    return redirect(f'/empresarios/empresa/{id}')
...
def excluir_dc(request, id):
    ...
    documento.delete()
    messages.add_message(request, constants.SUCCESS, "Documento excluído om sucesso")
